    ...
    var SliderModule = (function () {
        ...
        pb.init = function (settings) {
            ...
            for (var i = 0; i < lengthSlider; i++) {
                var imagenSrc = pb.items.panels.eq(i).find('img.miniatura').attr('src');
                if (i == 0) {
                    loscontroles += '<img class="active" src="' + imagenSrc + '" width="40" height="40">';
                } else {
                    loscontroles += '<img src="' + imagenSrc + '" width="40" height="40">';
                }
            }
            ...
            $('#control-buttons img').on("click", function () {
